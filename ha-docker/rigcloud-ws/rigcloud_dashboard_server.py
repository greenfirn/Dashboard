...
if MQTT_MODE == "local":
    ...
    MQTT_BROKER = os.getenv("MQTT_HOST")  # *.iot.<region>.amazonaws.com
    MQTT_PORT = int(os.getenv("MQTT_PORT", "8883"))

    MQTT_CERT = os.getenv("MQTT_CERT", "/certs/device.pem.crt")
    MQTT_KEY  = os.getenv("MQTT_KEY",  "/certs/private.pem.key")
