...
for %%I in (%RIGS%) do (
    ...
    plink -batch -pw %PASS% %USER%@%%I "sudo systemctl daemon-reload"

    echo Restarting rigcloud-agent.service...
    plink -batch -pw %PASS% %USER%@%%I "sudo systemctl restart rigcloud-agent.service"

    echo Checking status...
    plink -batch -pw %PASS% %USER%@%%I "sudo systemctl is-active rigcloud-agent.service"
)
